...
\item Both constraints active: $g_1(x^*, y^*) \approx 0$, $g_2(x^*, y^*) \approx 0$ $\checkmark$
\end{itemize}
...
\item Constraint verification: $g_1 \approx 0$, $g_2 = -5.21 < 0$ $\checkmark$ (feasible)
\end{itemize}
...
\item Numerical verification: Actual $\Delta f^* = 0.0801$ (error $< 0.001$) $\checkmark$
\end{itemize}
...
\clearpage
\begin{solution}[Problem 3.a - Conditional Distribution]
...
\clearpage
\begin{solution}[Problem 3.b - Conditional Mean]
...
\clearpage
\begin{solution}[Problem 3.c - Distribution of Conditional Mean]
