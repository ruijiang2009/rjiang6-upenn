...
best_n = -1
best_k = -1
best_accuracy = 0.10222222222222223
for n in range(5, 8):
    for k in range(1):
            ...
            for country_code in COUNTRY_CODES:
                ...
                with  zip_ref.open(file_name) as binary_file:
                    with io.TextIOWrapper(binary_file, encoding='utf-8', errors="ignore") as text_file:
                        country_to_models[country_code] = NgramModelWithInterpolation(n, k)
                ...
                with zip_ref.open(file_name) as binary_file:
                    with io.TextIOWrapper(binary_file, encoding='utf-8', errors="ignore") as text_file:
                        for line in text_file:
                            ...
                            min_country_code = 'af'
                            for country_code in country_to_models.keys():
                                nm_model = country_to_models[country_code]
...
n = 4
k = 0
country_models['af'] = NgramModelWithInterpolation(n, k)
country_models['cn'] = NgramModelWithInterpolation(n, k)
country_models['de'] = NgramModelWithInterpolation(n, k)
country_models['fi'] = NgramModelWithInterpolation(n, k)
country_models['fr'] = NgramModelWithInterpolation(n, k)
country_models['in'] = NgramModelWithInterpolation(n, k)
country_models['ir'] = NgramModelWithInterpolation(n, k)
country_models['pk'] = NgramModelWithInterpolation(n, k)
country_models['za'] = NgramModelWithInterpolation(n, k)
