# -*- coding: utf-8 -*-
"""CIS_5300_Homework_7_rjiang.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SIHMmbAkLujNfRMhdwD1keC-dmqJMwIk
...
# print(input_ids)
# print(bert_tokens)
tokenized = tokenizer(" ".join(tokens), padding="max_length", truncation=True, max_length=512)
input_ids = tokenized['input_ids']
bert_tokens = tokenizer.convert_ids_to_tokens(input_ids)
token_type_ids = tokenized['token_type_ids']
attention_mask = tokenized['attention_mask']
